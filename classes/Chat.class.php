...
class Chat {
	...
	public static function logout() {
		DB::query("DELECT FROM webchat_users WHERE name = '".DB::esc($_SESSION['user']['name'])."'");
	...
	public static function gravatarFromHash($hash, $size=23) {
		return 'http://www.gravatar.com/avatar/'.$hash.'?size='.$size.'&default='.urlencode('http://www.gravatar.com/avatar/ad516503a11cd5ca435acc9bb6523536?size='.$size);
	}
}